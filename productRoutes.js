...
const { showAllProducts, showSingleProduct, addProductPage, createProduct, editProductPage, deleteProduct, editProduct, createReview, deleteReview, addToCart, showCart } = require('../controllers/productController');
...
router.post('/cartdata/:pid', addToCart);
